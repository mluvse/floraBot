...
const TREES = [
  ...
  ['Сакура','Prunus serrulata','Розовые (Rosaceae)','Декоративное дерево 5–12 м, символ Японии. Широко культивируется во всём мире.','Цветки розовые или белые, 3–5 см, простые или махровые, по 3–5 штук в соцветии.','Март–Май',['Япония','Китай','Корея','Европа'],'https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/PNG_transparency_demonstration_1.png/280px-PNG_transparency_demonstration_1.png'],
  ...
  ['Персик обыкновенный','Prunus persica','Розовые (Rosaceae)','Плодовое дерево 4–8 м тёплых регионов.','Цветки ярко-розовые, 2.5–3.5 см, сидячие, появляются до листьев.','Март–Апрель',['Китай','Средняя Азия','Кавказ','Южная Европа'],'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Autumn_Red_peach.jpg/800px-Autumn_Red_peach.jpg'],
